...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userAdapter = UserAdapter { selecteduser ->
            ...
            Toast.makeText(this, "Selected User: ${selecteduser.name}",
        ...
        buttonAdd.setOnClickListener {
            ...
            if (name.isNotBlank() && age != null) {
                ...
                Toast.makeText(this, "Please provide valid input",
                    Toast.LENGTH_SHORT).show()
            }
        }
        // Update User
        ...
        buttonAddTask.setOnClickListener {
            ...
            if (selectedUserId != null && taskName.isNotBlank()) {
                ...
                Toast.makeText(this, "Select a user and provide a task name",
                    Toast.LENGTH_SHORT).show()
            }
        }
    }
